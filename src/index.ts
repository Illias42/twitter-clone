...
app.post('/register', upload.single("avatar"), UserControllers.register);
...
app.post('/createtweet', passport.authenticate("jwt"), upload.array("pics"), TweetControllers.createtweet);
